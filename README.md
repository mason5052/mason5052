...
- Currently **Global DevOps Engineer** at Zinus, Inc.
- Pursuing **MS Cybersecurity** at Georgia Institute of Technology (Expected 2026)
- **CEH** and **CASE Java** certified security professional
...
| Achievement | Impact |
|-------------|--------|
| Architected self-managed Kubernetes platform | 43 production workloads, 99.9%+ uptime |
| Platform modernization | **$94,000 annual cost savings** (94% reduction) |
| AWS WAF implementation | **90%+ security threat reduction** |
| Disaster response optimization | MTTR improved from days to **under 1 hour** |
| Global team leadership | 10-person DevOps team across US and Philippines |
...
| MS Cybersecurity | Georgia Tech | Expected 2026 |
